Used the "monitor" pattern to solve two synchronization problems with mutexes and condition variables to account for the security issues of multithreading. 
